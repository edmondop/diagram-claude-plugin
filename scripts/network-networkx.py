...
def main() -> None:
    ...
    layer_colors: dict[int, str] = {
        0: "#3498db", 1: "#2ecc71", 2: "#f39c12",
        3: "#e74c3c", 4: "#9b59b6", 5: "#1abc9c", 6: "#34495e",
    }
    node_colors = [
        layer_colors.get(G.nodes[n]["layer"], "#95a5a6") for n in G.nodes()
    ]

    fig, ax = plt.subplots(figsize=(12, 7))

    nx.draw_networkx_nodes(G, pos, ax=ax, node_color=node_colors,
                           node_size=2800, edgecolors="white", linewidths=2)
    nx.draw_networkx_labels(G, pos, ax=ax, font_size=9,
                            font_weight="bold", font_color="white")
    nx.draw_networkx_edges(G, pos, ax=ax, edge_color="#7f8c8d", width=2,
